...
{
    [CreateNodeMenu(AFXMenuTree.MathF + "MathF Min")]
    public class Min : AFXNode
    {
        ...
        public override object GetValue(NodePort port)
        {
            ...
            {
                return Mathf.Min((float)port1.GetInputValue(), (float)port2.GetInputValue());
            }
            else
            {
                return Mathf.Min((int)port1.GetInputValue(), (int)port2.GetInputValue());
            }
        }
