...
{
    [CreateNodeMenu(AFXMenuTree.List + "List Add")]
    public class ListAdd : AFXActiveNode
    {
        private const string portNameIn1 = "List";
        private const string portNameIn2 = "ItemToAdd";
        ...
        public override void ExecuteNode(AFXFlow afxFlow)
        {
            ...
            list.Add(GetInputPort(portNameIn2).GetInputValue());
