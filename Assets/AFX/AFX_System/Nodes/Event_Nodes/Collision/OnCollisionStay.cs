...
{
    [NodeTitle("OnCollisionStay")]
    [CreateNodeMenu(AFXMenuTree.EventsCollision + "OnCollisionStay")]
    public class OnCollisionStay : AFXEventNode
    {
        [SerializeField]
        ...
        private void Setup()
        {
            ...
            {
                colliderPassthrough.onCollisionStayEvent += OnCollision;
                Graph.AFXLateUpdate -= Setup;
            }
        }
