...
{
    [NodeTitle("Set ConnectedAnchor")]
    [CreateNodeMenu(AFXMenuTree.PhysicsRigidBodyJoint + "Set Joint ConnectedAnchor")]
    public class SetJointConnectedAnchor : AFXActiveNode
    {
        ...
        [SerializeField]
        [Input(ShowBackingValue.Unconnected)] private Vector3 connectedAnchor;
        ...
        public override void ExecuteNode(AFXFlow afxFlow)
        {
            ...
            connectedAnchor = GetInputValue(nameof(connectedAnchor), connectedAnchor);
