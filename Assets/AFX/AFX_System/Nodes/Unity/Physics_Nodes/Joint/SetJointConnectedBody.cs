...
{
    [NodeTitle("Set ConnectedBody")]
    [CreateNodeMenu(AFXMenuTree.PhysicsRigidBodyJoint + "Set Joint ConnectedBody")]
    public class SetJointConnectedBody : AFXActiveNode
    {
        ...
        [SerializeField]
        [Input] private Rigidbody connectedBody;
        ...
        public override void ExecuteNode(AFXFlow afxFlow)
        {
            ...
            connectedBody = GetInputValue(nameof(connectedBody), connectedBody);
