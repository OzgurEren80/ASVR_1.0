...
{
    [NodeTitle("Set EnableCollision")]
    [CreateNodeMenu(AFXMenuTree.PhysicsRigidBodyJoint + "Set Joint EnableCollision")]
    public class SetJointEnableCollision : AFXActiveNode
    {
