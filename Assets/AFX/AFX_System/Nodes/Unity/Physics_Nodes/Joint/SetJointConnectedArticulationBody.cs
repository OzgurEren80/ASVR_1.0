...
{
    [NodeTitle("Set ConnectedArticulationBody")]
    [CreateNodeMenu(AFXMenuTree.PhysicsRigidBodyJoint + "Set Joint ConnectedArticulationBody")]
    public class SetJointConnectedArticulationBody : AFXActiveNode
    {
        ...
        [SerializeField]
        [Input] private ArticulationBody connectedArticulationBody;
        ...
        public override void ExecuteNode(AFXFlow afxFlow)
        {
            ...
            connectedArticulationBody = GetInputValue(nameof(connectedArticulationBody), connectedArticulationBody);
            joint.connectedArticulationBody = connectedArticulationBody;
