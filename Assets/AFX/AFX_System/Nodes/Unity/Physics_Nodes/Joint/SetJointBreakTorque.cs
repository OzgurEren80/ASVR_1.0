...
{
    [NodeTitle("Set BreakTorque")]
    [CreateNodeMenu(AFXMenuTree.PhysicsRigidBodyJoint + "Set Joint BreakTorque")]
    public class SetJointBreakTorque : AFXActiveNode
    {
        ...
        [SerializeField]
        [Input(ShowBackingValue.Unconnected)] private float breakTorque;
        ...
        public override void ExecuteNode(AFXFlow afxFlow)
        {
            ...
            breakTorque = GetInputValue(nameof(breakTorque), breakTorque);
