...
{
    [NodeTitle("Set EnablePreprocessing")]
    [CreateNodeMenu(AFXMenuTree.PhysicsRigidBodyJoint + "Set Joint EnablePreprocessing")]
    public class SetJointEnablePreprocessing : AFXActiveNode
    {
        ...
        [SerializeField]
        [Input(ShowBackingValue.Unconnected)] private bool enableCollision;
        ...
        public override void ExecuteNode(AFXFlow afxFlow)
        {
            ...
            enableCollision = GetInputValue(nameof(enableCollision), enableCollision);
            joint.enablePreprocessing = enableCollision;
