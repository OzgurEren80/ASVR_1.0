...
{
    [NodeTitle("Set BreakForce")]
    [CreateNodeMenu(AFXMenuTree.PhysicsRigidBodyJoint + "Set Joint BreakForce")]
    public class SetJointBreakForce : AFXActiveNode
    {
        ...
        [SerializeField]
        [Input(ShowBackingValue.Unconnected)] private float breakForce;
        ...
        public override void ExecuteNode(AFXFlow afxFlow)
        {
            ...
            breakForce = GetInputValue(nameof(breakForce), breakForce);
