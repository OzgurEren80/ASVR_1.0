...
{
    [NodeTitle("TransformDirection")]
    [CreateNodeMenu(AFXMenuTree.TransformSpaceSwitching + "TransformDirection")]
    public class TransformDirection : AFXNode
    {
        [SerializeField]
        ...
        public override object GetValue(NodePort port)
        {
            ...
            return transformIn.TransformDirection(vector3In);
        }
    }
}