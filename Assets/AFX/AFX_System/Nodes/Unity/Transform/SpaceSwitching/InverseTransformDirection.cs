...
{
    [NodeTitle("InversTransformDirection")]
    [CreateNodeMenu(AFXMenuTree.TransformSpaceSwitching + "InverseTransformDirection")]
    public class InverseTransformDirection : AFXNode
    {
        [SerializeField]
        ...
        public override object GetValue(NodePort port)
        {
            ...
            return transformIn.InverseTransformDirection(vector3In);
        }
    }
}