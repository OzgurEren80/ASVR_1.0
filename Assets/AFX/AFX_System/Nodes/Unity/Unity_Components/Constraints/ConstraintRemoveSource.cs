...
{
    [NodeTitle("RemoveSource")]
    [CreateNodeMenu(AFXMenuTree.ComponentConstraint + "Constraint RemoveSource")]
    public class ConstraintRemoveSource : AFXActiveNode
    {
        ...
        [SerializeField]
        [Input(ShowBackingValue.Unconnected)] private int index;
