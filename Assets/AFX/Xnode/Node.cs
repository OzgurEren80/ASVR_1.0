...
#region Inputs/Outputs
        ...
        // <summary> Returns the field the port is based on. Should be overridden in all derived nodes with outputs. </summary>
        /// <param name="port">The requested port.</param>
        public virtual object GetField(NodePort port)
        {
            Debug.LogWarning("No GetField(NodePort port) override defined for " + GetType());
            return null;
        }
        #endregion
...
#region Attributes
        ...
        public class InputAttribute : Attribute {
            ...
            public InputAttribute(ShowBackingValue backingValue = ShowBackingValue.Never, ConnectionType connectionType = ConnectionType.Override, TypeConstraint typeConstraint = TypeConstraint.Strict, bool dynamicPortList = false) {
        ...
        /// <summary> Specify a color for this node type </summary>
        [AttributeUsage(AttributeTargets.Class, AllowMultiple = false)]
        public class NodeAccentTintAttribute : Attribute
        {
            public Color color;
            /// <summary> Specify a color for this nodes accent details</summary>
            /// <param name="r"> Red [0.0f .. 1.0f] </param>
            /// <param name="g"> Green [0.0f .. 1.0f] </param>
            /// <param name="b"> Blue [0.0f .. 1.0f] </param>
            public NodeAccentTintAttribute(float r, float g, float b)
            {
                color = new Color(r, g, b);
            }
            ...
            /// <summary> Specify a color for this node type </summary>
            /// <param name="hex"> HEX color value </param>
            public NodeAccentTintAttribute(string hex)
            {
                ColorUtility.TryParseHtmlString(hex, out color);
            }
        }
        ...
        {
            public string title;
            /// <summary> Specify a title for this node type </summary>
