...
namespace XNodeEditor {
    ...
    public static class NodeEditorPreferences {
        ...
        public class Settings : ISerializationCallbackReceiver {
            [SerializeField] private Color32 _gridLineColor = new Color(0.30f, 0.30f, 0.30f);
            public Color32 gridLineColor { get { return _gridLineColor; } set { _gridLineColor = value; _gridTexture = null; _crossTexture = null; } }

            [SerializeField] private Color32 _gridBgColor = new Color(0.13f, 0.13f, 0.13f);
        ...
        private static void PreferencesGUI() {
            ...
            if (GUILayout.Button(new GUIContent("Documentation", "https://docs.engagevr.io/afx-preview/afx/getting-started"), GUILayout.Width(100))) Application.OpenURL("https://docs.engagevr.io/afx-preview/afx/getting-started");
